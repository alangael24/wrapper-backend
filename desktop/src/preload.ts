...
const api: DesktopApi = Object.freeze({
  ...
  startCheckout: (tier: "basic" | "pro" | "business") => ipcRenderer.invoke("desktop:start-checkout", tier),
  ...
  startWhatsAppLink: () => ipcRenderer.invoke("desktop:start-whatsapp-link"),
  unlinkWhatsApp: () => ipcRenderer.invoke("desktop:unlink-whatsapp"),
